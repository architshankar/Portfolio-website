...
const Hero = () => {
  ...
  const socialLinks = [
    { icon: <FaDribbble className="text-xl" />, href: "#", label: "Dribbble" },
    { icon: <FaGithub className="text-xl" />, href: "https://github.com/architshankar", label: "GitHub" },
    { icon: <FaLinkedinIn className="text-xl" />, href: "https://www.linkedin.com/in/archit-shankar-815756262/", label: "LinkedIn" },
    { icon: <FaTwitter className="text-xl" />, href: "https://x.com/archit__shankar?t=pBR8mQiksXo75dJAsSsaIQ&s=09", label: "Twitter" },
  ];
      ...
      >
        ...
        >
          <h1
            ...
            style={{ fontFamily: "'Big Shoulders Display', sans-serif" }}
          >
            {/* Only render SplitText when fonts are loaded */}
            {fontsLoaded && (
              <>
                <SplitText
                  text="Archit"
            ...
            {/* Fallback text while fonts are loading */}
            {!fontsLoaded && (
              <div className={`${isMobile
                ? 'text-[clamp(8rem,18vw,15rem)]'
                : 'text-[clamp(8rem,18vw,15rem)]'
                } font-black text-[#e0f11f] transition-colors duration-300`}>
                <div>Archit</div>
                <div>Shankar</div>
              </div>
            )}
