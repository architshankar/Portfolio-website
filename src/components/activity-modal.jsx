...
//             className="bg-card w-full max-w-3xl max-h-[90vh] rounded-2xl shadow-2xl overflow-hidden"
//           >
...
//                   {activity.details.achievements && activity.details.achievements.length > 0 && (
//                     <div>
...
//             {/* Content with gallery and details side-by-side on desktop */}
...
//             {/* Footer */}
//             <div className="p-6 md:p-8 border-t border-border flex flex-wrap gap-4 justify-end">
//               <button
//                 onClick={onClose}
//                 className="px-6 py-3 bg-accent text-black font-medium rounded-lg hover:bg-opacity-90 transition-all shadow-lg"
//               >
